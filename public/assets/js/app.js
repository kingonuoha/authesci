...
// On page load or when changing themes, prefer an explicit user setting.
// Default to light mode unless the user explicitly set dark in localStorage.
...
// Change the icons inside the button based on previous settings (localStorage only)
