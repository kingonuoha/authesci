...
import { getAdminDashboardMetrics } from "@/app/(app)/actions/admin"; // Import the server action
...
import { StorageAnalyticsChart } from "@/components/modules/admin/StorageAnalyticsChart";
    ...
    return (
        <div className="container mx-auto py-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {metrics.storageAnalytics && (
            <StorageAnalyticsChart
                totalStorageUsed={metrics.storageAnalytics.totalStorageUsed}
                totalStorageCapacity={metrics.storageAnalytics.totalStorageCapacity}
                topUsersByStorage={metrics.storageAnalytics.topUsersByStorage}
