    ...
    return (
        <html lang="en" dir="ltr">
            <head>
                ...
                <link rel="stylesheet" href="/front-assets/css/ace-responsive-menu.css" />
            ...
            <body className="body-bg">
                ...
                {/* Scripts */}
                <Script src="/front-assets/js/jquery-3.6.4.min.js" strategy="beforeInteractive" />
                <Script src="/front-assets/js/jquery-migrate-3.0.0.min.js" strategy="beforeInteractive" />
                <Script src="/front-assets/js/popper.min.js" strategy="afterInteractive" />
                <Script src="/front-assets/js/bootstrap.min.js" strategy="afterInteractive" />
                <Script src="/front-assets/js/bootstrap-select.min.js" strategy="afterInteractive" />
                <Script src="/front-assets/js/jquery.mmenu.all.js" strategy="afterInteractive" />
                <Script src="/front-assets/js/ace-responsive-menu.js" strategy="afterInteractive" />
                <Script src="/front-assets/js/jquery-scrolltofixed-min.js" strategy="afterInteractive" />
                ...
                <Script src="/front-assets/js/jquery.counterup.js" strategy="afterInteractive" />
