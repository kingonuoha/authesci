...
export default async function ScientistProjectsPage() {
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400">View your active research collaborations</p>
        </div>
      </div>
      <ProjectList projects={projects} role="scientist" />
    </div>
  );
}
