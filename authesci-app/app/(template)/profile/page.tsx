        ...
        <div className="dashboard-main-body">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
                ...
                <ul className="flex items-center gap-[6px]">
                    ...
                    <li className="text-neutral-600 font-medium dark:text-white">View Profile</li>
                </ul>
            </div>
                ...
                <div className="col-span-12 lg:col-span-8">
                    <div className="card h-full border-0">
                        <div className="card-body p-6">
                            ...
                            <ul className="tab-style-gradient flex flex-wrap text-sm font-medium text-center mb-5" id="default-tab" role="tablist">
                                <li className="" role="presentation">
                                    <button onClick={() => setActiveTab('edit-profile')} className={`py-2.5 px-4 border-t-2 font-semibold text-base inline-flex items-center gap-3 text-neutral-600 ${activeTab === 'edit-profile' ? 'border-primary-600 text-primary-600' : 'border-transparent'}`} type="button" role="tab" aria-controls="edit-profile" aria-selected={activeTab === 'edit-profile'}>
                                        Edit Profile
                                    </button>
                                </li>
                                <li className="" role="presentation">
                                    <button onClick={() => setActiveTab('change-password')} className={`py-2.5 px-4 border-t-2 font-semibold text-base inline-flex items-center gap-3 text-neutral-600 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 ${activeTab === 'change-password' ? 'border-primary-600 text-primary-600' : 'border-transparent'}`} type="button" role="tab" aria-controls="change-password" aria-selected={activeTab === 'change-password'}>
                                        Change Password
                                    </button>
                                </li>
                                <li className="" role="presentation">
                                    <button onClick={() => setActiveTab('notification-password')} className={`py-2.5 px-4 border-t-2 font-semibold text-base inline-flex items-center gap-3 text-neutral-600 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 ${activeTab === 'notification-password' ? 'border-primary-600 text-primary-600' : 'border-transparent'}`} type="button" role="tab" aria-controls="notification-password" aria-selected={activeTab === 'notification-password'}>
                            ...
                            <div id="default-tab-content">
                                <div className={`${activeTab === 'edit-profile' ? '' : 'hidden'}`} id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                                ...
                                <div className={`${activeTab === 'change-password' ? '' : 'hidden'}`} id="change-password" role="tabpanel" aria-labelledby="change-password-tab">
                                    <div className="mb-5">
                                ...
                                <div className={`${activeTab === 'notification-password' ? '' : 'hidden'}`} id="notification-password" role="tabpanel" aria-labelledby="notification-password-tab">
