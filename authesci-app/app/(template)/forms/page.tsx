...
import { Home, Mail, Copy } from 'lucide-react';
        ...
        <div className="dashboard-main-body">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
                ...
                <ul className="flex items-center gap-[6px]">
                    ...
                    <li className="text-neutral-600 font-medium dark:text-white">Input Form</li>
                </ul>
            </div>
                            ...
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="col-span-12">
                                    ...
                                    <div className="flex">
                                        ...
                                        <button type="button" className="inline-flex items-center px-3 border rounded-s-0 border-s-0 rounded-e-md border-neutral-200 dark:border-neutral-600"><Copy />Copy</button>
                                    </div>
                        ...
                        <div className="card-body">
                            <div className="grid grid-cols-12 gap-4">
                                <div className="col-span-12">
                                    ...
                                    <input type="text" name="#0" className="form-control" placeholder="info@gmail.com" value="info@gmail.com" readOnly />
                                </div>
                                <div className="col-span-12">
                                    <label className="form-label">Input with Phone </label>
                                    <div className="flex">
