      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
        ...
        <ul className="flex items-center gap-[6px]">
          <li className="font-medium">
            <a href="index.html" className="flex items-center gap-2 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover:text-primary-600">
              <Home className="icon text-lg"></Home>
              Dashboard
            </a>
          </li>
          <li className="text-neutral-600 dark:text-white">-</li>
          <li className="text-neutral-600 font-medium dark:text-white">AI</li>
        </ul>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-6">
          ...
          <div className="card-body p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="w-[50px] h-[50px] bg-cyan-600 rounded-full flex justify-center items-center">
                <Users className="text-white text-2xl mb-0"></Users>
              </div>
            </div>
            <p className="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-success-600 dark:text-success-400"><ArrowUp className="text-xs"></ArrowUp> +4000</span>
              Last 30 days users
            </p>
          </div>
        </div>{/* card end */}
          ...
          <div className="card-body p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="w-[50px] h-[50px] bg-purple-600 rounded-full flex justify-center items-center">
                <Award className="text-white text-2xl mb-0"></Award>
              </div>
            </div>
            <p className="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-danger-600 dark:text-danger-400"><ArrowDown className="text-xs"></ArrowDown> -800</span>
        ...
        <div className="card shadow-none border border-gray-200 dark:border-neutral-600 dark:bg-neutral-700 rounded-lg h-full bg-gradient-to-r from-blue-600/10 to-bg-white">
          <div className="card-body p-5">
            ...
            <p className="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-success-600 dark:text-success-400"><ArrowUp className="text-xs"></ArrowUp> +200</span>
              Last 30 days users
            </p>
          </div>
        </div>{/* card end */}
          ...
          <div className="card-body p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="w-[50px] h-[50px] bg-success-600 rounded-full flex justify-center items-center">
                <Wallet className="text-white text-2xl mb-0"></Wallet>
              </div>
            </div>
            <p className="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-success-600 dark:text-success-400"><ArrowUp className="text-xs"></ArrowUp> +$20,000</span>
              Last 30 days income
            </p>
          </div>
        </div>{/* card end */}
          ...
          <div className="card-body p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="w-[50px] h-[50px] bg-red-600 rounded-full flex justify-center items-center">
                <FileText className="text-white text-2xl mb-0"></FileText>
              </div>
            </div>
            <p className="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-success-600 dark:text-success-400"><ArrowUp className="text-xs"></ArrowUp> +$5,000</span>
            ...
            <div className="card-body">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-2">
                ...
                <span className="text-sm font-semibold rounded-full bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-200 dark:border-success-600/50 px-2 py-1.5 line-height-1 flex items-center gap-1">
                  10% <ArrowUp className="text-xs"></ArrowUp>
                </span>
            ...
            <div className="card-body p-6">
              ...
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-sm font-semibold rounded-full bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 border border-danger-200 dark:border-danger-600/50 px-2 py-1.5 line-height-1 flex items-center gap-1">
                  10% <ArrowDown className="icon"></ArrowDown>
                </span>
                - 20 Per Day
              </div>
            ...
            <div className="card-body p-6">
              ...
              <ul className="flex flex-wrap items-center justify-between mt-4 gap-3">
                <li className="flex items-center gap-2">
                  <span className="w-3 h-3 rounded-sm bg-primary-600"></span>
                ...
                <li className="flex items-center gap-2">
                  <span className="w-3 h-3 rounded-sm bg-warning-600"></span>
            ...
            <div className="card-body">
              <div className="flex items-center flex-wrap gap-2 justify-between">
                ...
                <a href="javascript:void(0)" className="text-primary-600 dark:text-primary-600 hover-text-primary flex items-center gap-1">
                  View All
                  <ArrowRight className="icon"></ArrowRight>
                </a>
              </div>
          ...
          <div className="card h-full border-0">
            <div className="card-body">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div id="world-map" className="h-full border border-neutral-200 dark:border-neutral-600 rounded-lg"></div>
...
// Note: The <iconify-icon> tags are not standard HTML and will not render without a library.
// These should be replaced with a suitable React icon library.
