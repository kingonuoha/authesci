import { getPayouts, getPayoutStats } from "@/app/actions/payment";
...
export default async function AdminPayrollPage() {
    ...
    const stats = statsResult.data || { pendingCount: 0, pendingAmount: 0, completedCount: 0, completedAmount: 0 };
